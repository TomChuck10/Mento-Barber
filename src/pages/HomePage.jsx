					...
					<div className='w-full'>
						<Slider {...settings} className='space-x-4'>
							{[
								...
								<div
									key={index}
									className='p-2 border-[3px] border-prime rounded-md shadow-[0_0_7px_rgba(255,120,0,0.8),inset_0_0_7px_rgba(255,120,0,0.8)]'
									style={{
										margin: "0px 10px", // Odstępy między elementami
									}}>
									<img
										src={photo}
										alt='Haircut'
